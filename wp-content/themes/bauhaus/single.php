	...
	<section class="container">
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			<div class="contentLeft">
				<div <?php post_class('singlePost clear') ?>>
        ...
        ?>
				...
				<div class="singlePostTags clear">
                    <?php the_tags( '<span>'.__('Tags', 'bauhaus').':</span>', ', ', '' ); ?>
				</div>
        ...
        ?>
                <?php if ( isset($sPrevPostId) && !empty($sPrevPostId) ) { ?>
					<a href="<?php echo esc_url( get_permalink( $sPrevPostId ) ); ?>" class="postPrev">
						<i>
						...
						<?php _e('previous', 'bauhaus') ?>
					</a>
                <?php } ?>
                <?php if ( isset($sNextPostId) && !empty($sNextPostId) ) { ?>
					<a href="<?php echo esc_url( get_permalink( $sNextPostId ) ); ?>" class="postNext">
						<i>
                ...
                <?php if ( ot_get_option( 'uni_display_similar_posts' ) == 'on' ) { ?>
                <?php uni_similar_posts_by_tags(); ?>
                <?php } ?>
        ...
        <?php endwhile;
			...
			<div class="contentLeft">
				<div class="singlePost clear">
				    <h2><?php _e('Nothing Found', 'bauhaus') ?></h2>
				    <a href="<?php if ( function_exists('icl_get_languages') ) { echo esc_url( icl_get_home_url() ); } else { echo esc_url( home_url( '/' ) ); } ?>" class="thm-btn-1 back-to"><?php _e('homepage', 'bauhaus') ?></a>
			    </div>
            </div>
